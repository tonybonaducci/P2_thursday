...
##Arreglar el tema de que tam_población no es siempre 50
#tam_poblacion = 50
...
def seleccion(poblacion,train_set, test_set, train_set_size, test_set_size,atributes,tam_poblacion):
    n_atr = len(atributes)
...
def AGG_BLX(train_set, test_set, train_set_size, test_set_size,weights,atributes,tam_poblacion):
    ...
    p_intermedia_cruce = seleccion(poblacion,train_set, test_set, train_set_size, test_set_size,atributes,tam_poblacion) 
    ...
    while(n_evaluaciones<5):
        ...
        for i in range(tam_poblacion-1):
            ...
            elif(i>n_esperado_cruces):
                p_intermedia_mutacion[i]=p_intermedia_cruce[i]
...
def AGG_aritmetico(train_set, test_set, train_set_size, test_set_size,weights,atributes,tam_poblacion):
...
def AGE_BLX(train_set, test_set, train_set_size, test_set_size,weights,atributes,tam_poblacion):
...
def AGE_aritmetico(train_set, test_set, train_set_size, test_set_size,weights,atributes,tam_poblacion):
